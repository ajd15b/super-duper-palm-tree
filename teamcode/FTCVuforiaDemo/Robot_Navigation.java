...
public class Robot_Navigation
{
    ...
    public void initVuforia(LinearOpMode opMode, Robot_OmniDrive robot) {
        ...
        // and paste it here...
        parameters.vuforiaLicenseKey = "";
    ...
    public boolean targetIsVisible(int targetId) {
        ...
        if ((target != null) && (listener != null) && listener.isVisible()) {
            ...
            if (location != null) {
                ...
                //0 at the target, negative as we get away from it
                robotX = trans.get(0);
                //Positive right, negative left
                robotY = trans.get(1);

                // Robot bearing (in +vc CCW cartesian system) is defined by the standard Matrix z rotation
                //What direction are we pointing (Not at the target, just in general)
                ...
                //How far off our center line the actual target is. How far we have to turn to see the target
